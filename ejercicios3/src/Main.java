...
public class Main {
    public static void main(String[] args) {
        ...
        neymar.anotarGol();
        neymar.anotarGol();
        System.out.println("Goles de neymar: " + neymar.getCantDeGoles());
        System.out.println("Maximo goleador: " + Futbolista.maximoGoleador.getNombre());
        messi.anotarGol();
        messi.anotarGol();
        System.out.println("Goles de messi: " + messi.getCantDeGoles());
        System.out.println("Maximo goleador " + Futbolista.maximoGoleador.getNombre());
